...
base_data AS (
 select 
    {{ dbt_utils.generate_surrogate_key(['vendorid', 'tpep_pickup_datetime', 'tpep_dropoff_datetime', 'pulocationid', 'dolocationid']) }} as trip_key, 
    vendorid,
...
SELECT bd.trip_key, bd.vendorid, -- je vais laisser les ligne où ça ne correspond pas à 2,1,... à 45 par ex pour tester la performance des résultats requis dans le rapport
